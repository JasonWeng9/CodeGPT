...
class ComputeLoss:
    ...
    def __call__(self, outputs, targets):
        ...
        # print(scores, bboxes, gt_labels, gt_bboxes, mask_gt, anchor_points * stride_tensor)
        target_bboxes, target_scores, fg_mask = self.assign(scores, bboxes, gt_labels, gt_bboxes, mask_gt, anchor_points * stride_tensor)
    ...
    def assign(self, pred_scores, pred_bboxes, true_labels, true_bboxes, true_mask, anchors):
        ...
        # print(target_bboxes, target_scores, fg_mask.bool())
